...
import coverTeam from "../assets/img/coverTeam.jpeg"
import Titles from '../components/Titles'
export default function Contact() {
  return (
<div className='mb-[110px]'>
  <HeaderPage img={coverTeam} />
  <Titles title="Get in " subtitle="Have a specific inquiry or looking to explore new opportunities? Our experienced team is ready to engage with you." marked={"Touch"}/>
    <div
    ...
    <div class="sm:p-10 max-sm:px-4 max-sm:py-8 " style={{backgroundColor:"#000168"}}>
        ...
        <form>
            ...
            <button type="button"
                class="mt-8 flex items-center justify-center text-sm w-full rounded px-4 py-2.5   text-white hover:bg-yellow-700" style={{backgroundColor:"#95653e"}}>
        ...
        <ul class="mt-4 flex justify-center lg:space-x-6 max-lg:flex-col max-lg:items-center max-lg:space-y-2 ">
            <li class="flex items-center" style={{color:"#95653e"}}>
