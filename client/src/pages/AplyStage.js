...
export default function Aply() {
  ...
  return (
    ...
    <div className="mb-[110px]">
      ...
      <Titles title="Intern " subtitle="Take the Next Step in Your Professional Journey" marked="Submission" />
      <ToastContainer />
      ...
      <div class=" p-6 bg-gray-100 flex items-center justify-center">
        ...
        <div class="">
          ...
          <HorizantalCard title={offre?.title} service={offre?.services?.title} description={offre?.description} skills={offre?.offerSkills?.map((skill) => skill.Skills.name)} time={offre?.created_at} nobtn={true} />
          <div class="bg-white flex flex-col rounded shadow-lg  my-6">
            <div class="h-[6px] w-full " style={{ backgroundColor: "#22ad9a" }}></div>
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3  p-8">
