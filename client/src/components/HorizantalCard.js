...
export default function HorizantalCard({description,title,time,btn1,btn2,skills,onClickBtn2}) {
console.log(time,"tiiiiiiiii");
...
const formattedTime = new Date(`${time}`).toLocaleDateString('en-US', {
  ...
  return (
    <div class=" flex justify-center items-center">
        <div class="w-full m-5  flex flex-col bg-white shadow-lg rounded-lg overflow-hidden">
          <div class=" text-white text-lg px-6 py-4" style={{ background: "#22ad9a", color: "white" }}>{title}</div>
